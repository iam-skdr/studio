  ...
  return (
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden text-center">
      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold font-headline text-primary-foreground tracking-tighter mb-4">
          <span
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Button size="lg" asChild className="glassmorphism hover:bg-primary/50 text-primary-foreground text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-primary/50 transition-shadow">
            <a href="#projects">View My Work</a>
          </Button>
          <Button size="lg" variant="outline" asChild className="glassmorphism bg-transparent hover:bg-white/10 text-primary-foreground text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-accent/50 transition-shadow">
